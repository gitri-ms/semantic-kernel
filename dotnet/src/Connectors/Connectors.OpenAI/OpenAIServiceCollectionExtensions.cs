...
public static class OpenAIServiceCollectionExtensions
{
    ...
    public static IKernelBuilder AddAzureOpenAISpeechRecognition(
        this IKernelBuilder builder,
        string deploymentName,
        string endpoint,
        string apiKey,
        ...
        HttpClient? httpClient = null)
    {
        ...
        builder.Services.AddKeyedSingleton<ISpeechRecognitionService>(serviceId, (serviceProvider, _) =>
        {
            var client = CreateAzureOpenAIClient(endpoint, new AzureKeyCredential(apiKey), httpClient ?? serviceProvider.GetService<HttpClient>());
            return new AzureOpenAISpeechRecognitionService(deploymentName, client, serviceProvider.GetService<ILoggerFactory>());
        });
